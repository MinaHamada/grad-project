...
class Surgery_Details extends StatelessWidget {
  const Surgery_Details({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state) {
        ...
        // var Operation_Name = TextEditingController();
        // var Operation_Date = TextEditingController();
        // var Operation_Report = TextEditingController();
        List body = [
          const HomeIndex(),
                      ...
                      child: Column(
                        ...
                        children: [
                          header(
                            ...
                            text: 'Surgery details'.toUpperCase(),
                          ),
