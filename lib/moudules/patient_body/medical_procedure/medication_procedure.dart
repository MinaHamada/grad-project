...
class Medication_Procedure extends StatelessWidget {
  const Medication_Procedure({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state) {
        ...
        // var Procedure_Name = TextEditingController();
        // var Performance_Date = TextEditingController();
        // var Performed_By = TextEditingController();
                      ...
                      child: Column(
                        ...
                        children: [
                          header(
                            ...
                            text: 'medical procedure'.toUpperCase(),
                          ),
                          ...
                          fillName_Date(
                              ...
                              height: height,
                              cubit: cubit,
                              image: 'image/main/medical_procedure1.png'),
                          SizedBox(height: height * 10 / 100),
